...
run_tests: tests/main.cpp tests/test_Sample.cpp tests/test_Channel.cpp tests/test_AudioGen.cpp src/Channel.h src/Sample.h
	c++ $(CFLAGS) -Ivendors/googletest/googletest/include -Isrc -Lvendors/googletest/lib -lgtest tests/main.cpp tests/test_Sample.cpp tests/test_Channel.cpp tests/test_AudioGen.cpp -o run_tests